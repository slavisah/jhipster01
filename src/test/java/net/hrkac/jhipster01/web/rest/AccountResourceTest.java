package net.hrkac.jhipster01.web.rest;

import net.hrkac.jhipster01.Application;
import net.hrkac.jhipster01.domain.Authority;
import net.hrkac.jhipster01.domain.User;
import net.hrkac.jhipster01.repository.AuthorityRepository;
import net.hrkac.jhipster01.repository.UserRepository;
import net.hrkac.jhipster01.security.AuthoritiesConstants;
import net.hrkac.jhipster01.service.MailService;
import net.hrkac.jhipster01.service.UserService;
import net.hrkac.jhipster01.web.rest.dto.UserDTO;
